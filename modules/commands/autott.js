...
{
    timer: '7:30:00 AM',
    message: ['𝗖𝗼́ 𝘁𝗵𝗲̂̉ 𝗯𝗮̣𝗻 𝘁𝗵𝘂̛̀𝗮 𝗯𝗶𝗲̂́𝘁: {thuabiet}\n━━━━━━━━━━━━━\n➝ Đ𝗮̂𝘆 𝗹𝗮̀ 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝘁𝘂̛̣ đ𝗼̣̂𝗻𝗴']
},
...
module.exports.onLoad = o => setInterval(async () => {
    ...
    if (á = nam.find(i => i.timer == new Date(Date.now() + 25200000).toLocaleString().split(/,/).pop().trim())) {
        ...
        msg = msg.replace(/{time}/g, require("moment-timezone").tz("Asia/Ho_Chi_Minh").format("HH:mm:ss (D/MM/YYYY) (dddd)")).replace(/{thuabiet}/g, (await axios.get(`https://trinkers.glitch.me/thuabiet`)).data.data)
        msg = { body: msg };
